...
DEFAULT_EVAL_CASES: tuple[dict[str, Any], ...] = (
    ...
    {
        "id": "semantic-paraphrase-001",
        "layer": "semantic_paraphrase",
        "input_message": "帮我看看明天出门要不要带伞",
        "expectation": "must_call_tool",
        "scenario": "group_plugin_selector",
        "min_tool_calls": 1,
        "tags": ["plugin", "zero_overlap", "intent_phrasing"],
    },
    {
        "id": "semantic-paraphrase-002",
        "layer": "semantic_paraphrase",
        "input_message": "Nice to meet you 这句用咱们的话怎么说",
        "expectation": "must_call_tool",
        "scenario": "group_plugin_selector",
        "min_tool_calls": 1,
        "tags": ["plugin", "zero_overlap", "colloquial"],
    },
    {
        "id": "semantic-paraphrase-003",
        "layer": "semantic_paraphrase",
        "input_message": "日常那个领奖励的事帮我办一下",
        "expectation": "must_call_tool",
        "scenario": "group_plugin_selector",
        "min_tool_calls": 1,
        "tags": ["plugin", "zero_overlap", "vague_reference"],
    },
    {
        "id": "semantic-paraphrase-004",
        "layer": "semantic_paraphrase",
        "input_message": "放首适合下雨天听的曲子",
        "expectation": "must_call_tool",
        "scenario": "group_plugin_selector",
        "min_tool_calls": 1,
        "tags": ["plugin", "zero_overlap", "synonym"],
    },
    {
        "id": "semantic-paraphrase-005",
        "layer": "semantic_paraphrase",
        "input_message": "发张好看的动漫小姐姐图养养眼",
        "expectation": "must_call_tool",
        "scenario": "group_plugin_selector",
        "min_tool_calls": 1,
        "tags": ["plugin", "zero_overlap", "colloquial"],
    ...
    {
        "id": "semantic-paraphrase-006",
        "layer": "semantic_paraphrase",
        "input_message": "用神秘学的方式帮我算算今天适不适合表白",
        "expectation": "must_call_tool",
        "scenario": "group_plugin_selector",
        "min_tool_calls": 1,
        "tags": ["plugin", "zero_overlap", "intent_phrasing"],
    ...
    {
        "id": "semantic-paraphrase-007",
        "layer": "semantic_paraphrase",
        "input_message": "看看我攒的那些虚拟货币还剩多少",
        "expectation": "must_call_tool",
        "scenario": "group_plugin_selector",
        "min_tool_calls": 1,
        "tags": ["plugin", "zero_overlap", "synonym"],
    ...
    {
        "id": "semantic-paraphrase-008",
        "layer": "semantic_paraphrase",
        "input_message": "zqsg 这种网络缩写到底是啥意思，给我掰扯掰扯",
        "expectation": "must_call_tool",
        "scenario": "group_plugin_selector",
        "min_tool_calls": 1,
        "tags": ["plugin", "zero_overlap", "colloquial"],
    ...
    {
        "id": "semantic-paraphrase-chat-001",
        "layer": "semantic_paraphrase",
        "input_message": "我朋友说他坚持每天早起打卡跑步，太自律了，你怎么看",
        "expectation": "direct_chat",
        "scenario": "group_plugin_selector",
        "tags": ["chat", "zero_overlap", "third_person"],
    },
    {
        "id": "semantic-paraphrase-chat-002",
        "layer": "semantic_paraphrase",
        "input_message": "如果哪天有人让你把整段话变成英文，你一般是怎么处理的",
        "expectation": "direct_chat",
        "scenario": "group_plugin_selector",
        "tags": ["chat", "zero_overlap", "meta_discussion"],
    },
    {
        "id": "no-tool-001",
